...
const polcyopSchema = new Schema(
  {
    ...
    installmentDetails: [{
      ...
      installmentStatus: { type: String, required: true, enum: ['Pending', 'Paid'], default: 'Pending' },
    }],
    premiumAmount: { type: String, trim: true },
    gstAmount: { type: String, trim: true },
    pendingPremiumAmount: { type: String, trim: true },
    pendingGstAmount: { type: String, trim: true },
