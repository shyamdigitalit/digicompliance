...
export const getAllPolicyDetails = async (filter) => {
    try {
        ...
        const pipeline = [
            ...
            { $set: { policytypeName: '$policyType.policytypeName'}},
            ...
            { $set: { insuranceProviderName: '$insurerName.providerName'}},
            ...
            { $set: { insuredCompanyCode: '$insuredName.companyCode'}},
            ...
            { $set: { plantName: '$plantLocation.unitName'} },
            ...
            { $set: { brokerName: '$broker.brokerName'}},
            ...
            { $set: { createdby: '$createdby.acc_fname'}},
            ...
            { $set: { updatedby: '$updatedby.acc_fname'}},
...
const update = async (req, res) => {
    try {
        ...
        console.log(nfaForPaymentPayld);
        ...
        if (apprvFlg < 2) {
            ...
            if (polcyopRecord && polcyopRecord !== null) {
                ...
                console.log("Existing Files in DB:", polcyopRecord.nfaForPayment);
                ...
                // console.log("Files to be removed:", nfaForPaymentRmv);
                ...
                // console.log("After Removal updated record:", updtPolcyRecord);
