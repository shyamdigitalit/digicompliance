...
const Users = () => {
  ...
  const [data, setData] = useState(() => {
    try { return JSON.parse(localStorage.getItem(USER_KEY)) || defaultData; }
                ...
                {paged.length === 0 ? (
                  ...
                  <tr key={i}>
                    ...
                    <td style={{ display: "flex", gap: "8px" }}>
                      ...
                      <button onClick={() => handleDelete(user.username)} style={{ background: "none", border: "none", cursor: "pointer", color: "#ef4444", fontSize: "15px" }} title="Delete">🗑</button>
                    </td>
                  </tr>
                ))}
              </tbody>
